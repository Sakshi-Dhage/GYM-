        ...
        <div class="row m-auto">
          ...
          <div class="col-8">                        
            ...
            <form method="POST" action="query.php" enctype="multipart/form-data">
              ...
              <div class="mb-3">  
                <textarea class="form-control" name="adr" id="exampleFormControlTextarea1" rows="3" placeholder="Enter Address"></textarea>
              </div>
              <div class="mb-3">
              <label for="shift">Choose shift:</label>
              <select name="shift" id="shift"  class="form-control" >
                 <option value="1">1st shift:7-11am</option>
                 <option value="2">2nd shift:12-4pm</option>
                 <option value="3">3rd shift:6-10pm</option>
                
               </select>
               
              </div>
              <div class="mb-3">
                <input type="text" class="form-control" name="Trainer" id="Trainer" placeholder="Enter Trainer name">
              </div>
