...
<html lang="en">
  ...
  <body>
        ...
        <main class="container-fluid row m-auto">
            <p class="bg-dark text-center fw-bold text-light fs-3"> Member Details</p>
    ...
    <nav class="container-fluid row m-auto">
        <P class="bg-dark text-center fw-bold text-light fs-3">Trainer Details</P>
      <div class="row border-3">
        <?php while($data=mysqli_fetch_assoc($run)) { ?>
        <div class="col-2 text-center">
            <img src="<?php echo $data['photo']; ?>" alt="#" height="30px" id="photo">
